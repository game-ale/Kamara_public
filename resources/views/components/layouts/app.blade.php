            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
                ...
                <div class="lg:col-span-1">
                    ...
                    <div class="flex gap-3">
                        <a href="#" class="w-9 h-9 bg-white/10 rounded-lg flex items-center justify-center hover:bg-gold-500 transition-colors">
                ...
                <div>
                    ...
                    <ul class="space-y-4 text-sm">
                        <li class="flex items-start gap-3">
                            ...
                            <span>Bole Road, Adama, Ethiopia</span>
                        </li>
                        <li class="flex items-start gap-3">
                        ...
                        <li class="flex items-start gap-3">
                            ...
                            <span>info@kamaraschool.com</span>
                        </li>
                    </ul>
                </div>
            </div>
